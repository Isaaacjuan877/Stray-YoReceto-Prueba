...
<section class="cuerpo">
			...
			<div class="comunicado">
							<H2>Mascota desaparecida</H2>
						</div>
			<div class="carga">			
			<form action="cargar_II.php" method="post" enctype="multipart/form-data">
						<label> Tipo de mascota</label>
						<div class="">
							<input type="radio" name="tm" id="perros" value="Canino"required>
							<label for="perros">Canino</label>
							<input type="radio" name="tm" id="gatos" value="Felino"required>
							<label for="gatos">Felino</label>
							<input type="radio" name="tm" id="otros" value="Otro"required>
