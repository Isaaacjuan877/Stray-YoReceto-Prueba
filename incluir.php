...
if (empty($correo) or empty($clave) or empty($c_clave)) {
		...
		$ins = $conn -> query("INSERT INTO usuarios(id,Nombre,II_nombre,Apellido,II_apellido,Correo,Clave,Confirm_clave)VALUES ('','$nombre','$II_nombre','$apellido','$II_apellido','$correo','$clave','$c_clave')");
