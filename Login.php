			...
			<nav id="barra" class="navbar navbar-expand-lg navbar-light bg-light">
			   <ul id="ul" class="nav nav-tabs">
					...
					<li class="nav-item dropdown">
					    <a class="nav-link dropdown" href="cargar.php" >Subir informacion</a> 
					</li>
			...
			<section class="cuerpo">
					...
					<div id="registrate">
				          ...
				          <form action="Login.php" method="POST">
						      	<input name="email_i" type="email" placeholder="Correo elctronico">
						      	<input name="password_i" type="password" placeholder="Contraseña">
						      	<div class="Recuerdame">
									<input type="checkbox" name="Recuerdame" id="Recuerdame" placeholder="">
									<label for="Recuerdame">Recuerdame</label>
										
								</div>
						      	
						      	<input id="envio_i" type="submit" value="INICIAR SESSION">
						</form> 
						<div class="ad">
						        <p>¿Olvidaste tu contraseña?</p>
						        <p><a href="singup.php">Registrar una cuenta nueva</a></p>
						</div>
					</div>
